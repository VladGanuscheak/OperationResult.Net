...
{
    public class GenericFailureOperationResultTests
    {
        #region Common
        ...
        {
            // Arrange
            var failureOperationResult = new FailureOperationResult<float>();
        ...
        public void FailureOperationResult_NoGenericWithAnEmptyMessage_ArgumentException()
        {
            ...
            var failureOperationResult = new FailureOperationResult<double>();
        ...
        public void FailureOperationResult_NoGenericWithError_True()
        {
            ...
            // Act
            var failureOperationResult = new FailureOperationResult<long>();
        ...
        {
            // Act
            var failureOperationResult = new FailureOperationResult<byte>();
